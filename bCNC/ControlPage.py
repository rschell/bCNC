...
class continuousControlFrame(CNCRibbon.PageExLabelFrame):
    def __init__(self, master, app):
        CNCRibbon.PageExLabelFrame.__init__(self, master, "continuousControl",
            _("continuousControl"), app)
    ...
    def moveXup(self, event=None):
        ...
        self.app.mcontrol.jog("X{:.3f}".format(safeX), self.jograte.get())
    ...
    def moveYup(self, event=None):
        ...
        self.app.mcontrol.jog("Y{:.3f}".format(safeY), self.jograte.get())
    ...
    def moveXdownYup(self, event=None):
        ...
        self.app.mcontrol.jog("X{:.3f} Y{:.3f}".format(-safeD, safeD), self.jograte.get())
    ...
    def moveZup(self, event=None):
        ...
        self.app.mcontrol.jog("Z{:.3f}".format(safeZ), self.jograte.get())
